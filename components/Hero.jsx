      ...
      <div className="space-y-8 px-8 text-center relative z-10">
        <div className="space-y-6 mx-auto">
          ...
          <motion.h1
            ...
            className="text-4xl font-extrabold md:text-5xl lg:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-sky-400 to-blue-600 animate-text-glow"
          >
            <TypeAnimation
              sequence={[
