      ...
      <Card className="max-w-4xl mx-auto shadow-sm">
        ...
        <CardContent className="text-gray-400 prose prose-gray dark:prose-invert max-w-none">
          ...
          <ul>
            <li><strong>Service Providers:</strong> We may share information with third-party vendors and service providers who perform services on our behalf, such as:
              <ul>
                ...
                <li>Database Hosting: [Your Database Provider]</li>
                <li>Analytics Providers: [e.g., Google Analytics or Plausible Analytics]</li>
              </ul>
          ...
          <ul>
            ...
            <li><strong>Tracked App Data / Vault Items / Presets:</strong> Retained until deleted by you or your account is deleted.</li>
            <li><strong>User Breach Links:</strong> Retained until you delete your account.</li>
            <li><strong>Usage Logs:</strong> May be retained for a limited period for analysis and security purposes.</li>
          </ul>
          <p>You may be able to delete your account and associated data through your account settings.</p>

          <h2>6. Your Privacy Rights</h2>
          <p>Depending on your jurisdiction, you may have the right to:</p>
          <ul>
            <li><strong>Access:</strong> Request to view the personal data we hold about you.</li>
            <li><strong>Correction:</strong> Request corrections to any inaccurate data.</li>
            <li><strong>Deletion:</strong> Request we delete your data, with certain exceptions.</li>
            <li><strong>Object/Restrict:</strong> Request we limit or stop processing your data.</li>
          </ul>
          <p>To exercise any of these rights, please contact us via the information below.</p>
